...
var destinationMarker = new mapboxgl.Marker({ color: '#ff0000' }) // เลือกสีส้มสำหรับเครื่องหมาย
  .setLngLat([99.82660746718845, 19.903328615852942])
  .addTo(map);
...
if ("geolocation" in navigator) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    destinationMarker.setLngLat([99.82660746718845, 19.903328615852942]);


    var directionsAPI = 'https://api.mapbox.com/directions/v5/mapbox/driving/' + lng + ',' + lat + ';' + '99.82660746718845' + ',' + '19.903328615852942' + '?steps=true&geometries=geojson&access_token=' + mapboxgl.accessToken;
    fetch(directionsAPI)
